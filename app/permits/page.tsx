  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#F8FAFC', display: 'flex', flexDirection: 'column' }}>
      ...
      >
        ...
        <span style={{ fontSize: 12, color: '#6B7280', fontFamily: 'Instrument Sans, system-ui, sans-serif' }}>·</span>
        <span style={{ fontSize: 14, fontWeight: 600, color: '#111827', fontFamily: 'Instrument Sans, system-ui, sans-serif' }}>
          Recent Permits
        </span>
        <div style={{ flex: 1 }} />
        <Link
      ...
      <div style={{ maxWidth: 1200, width: '100%', margin: '0 auto', padding: '24px 20px 40px', flex: 1 }}>
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 20, flexWrap: 'wrap' }}>
          <div style={{ display: 'flex', gap: 4, alignItems: 'center' }}>
            <span style={{ fontSize: 12, color: '#6B7280', fontFamily: 'Instrument Sans, system-ui, sans-serif', marginRight: 4 }}>
              Window:
            </span>
            {([
                ...
                >
                  ...
                  {isOpen && (
                    <div style={{
                      ...
                      {!permit.abstract ? (
                        <div style={{ fontSize: 12, color: '#94A3B8', fontFamily: 'Instrument Sans, system-ui, sans-serif' }}>
                          Couldn&apos;t match this permit to a tract (missing lat/lon).
                        </div>
                      ) : loadingOwners ? (
                        <div style={{ fontSize: 12, color: '#6B7280', fontFamily: 'Instrument Sans, system-ui, sans-serif' }}>
