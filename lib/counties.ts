...
export const COUNTIES: Record<string, County> = {
  howard: {
    ...
    geoJsonPath: '/howard_parcels_enriched.geojson?v=2026roll-2',
    mapGeoJsonPath: '/howard_parcels_map.geojson?v=2026roll-2',
  ...
  glasscock: {
    ...
    geoJsonPath: '/glasscock_parcels_enriched.geojson?v=2026roll-2',
    mapGeoJsonPath: '/glasscock_parcels_map.geojson?v=2026roll-2',
    ownershipPctIsDecimal: true,
    abstractField: 'ABSTRACT_L',
    nriCode: '',
    operatorPatterns: [
  ...
  winkler: {
    ...
    mapGeoJsonPath: '/winkler_parcels_map.geojson?v=2026roll-2',
  ...
  reeves: {
    ...
    geoJsonPath: '/reeves_parcels_enriched.geojson?v=2026survey-1',
    mapGeoJsonPath: '/reeves_parcels_map.geojson?v=2026survey-1',
    ownershipPctIsDecimal: true,
    abstractField: 'ABSTRACT_L',
    nriCode: '',
    operatorPatterns: [
  ...
  pecos: {
    ...
    geoJsonPath: '/pecos_parcels_enriched.geojson?v=2026survey-1',
    mapGeoJsonPath: '/pecos_parcels_map.geojson?v=2026survey-1',
    ownershipPctIsDecimal: true,
    abstractField: 'ABSTRACT_L',
    nriCode: '',
    operatorPatterns: [
  ...
  crane: {
    ...
    name: 'Crane',
    state: 'TX',
    displayName: 'Crane County, TX',
    mapCenter: [-102.55, 31.40],
    mapZoom: 10,
    fips: '48103',
    fipsCode: '103',
    ownershipTable: 'crane_mineral_ownership',
    wellsTable: 'crane_wells',
    geoJsonPath: '/crane_parcels_enriched.geojson?v=2026survey-1',
    mapGeoJsonPath: '/crane_parcels_map.geojson?v=2026survey-1',
    ownershipPctIsDecimal: true,
    abstractField: 'ABSTRACT_L',
    nriCode: '',
    operatorPatterns: [
      'oxy', 'occidental', 'xto', 'exxon', 'apache', 'diamondback',
      'surge', 'pioneer', 'permian resources', 'conoco', 'conocophillips',
      'blackbeard',
    ],
    wellsJoinStrategy: 'abstract',
    breakdown: [
      { operator: 'Oxy / XTO', pct: 28 },
      { operator: 'Apache', pct: 16 },
      { operator: 'Diamondback E&P', pct: 12 },
      { operator: 'Other', pct: 44 },
    ],
  },
}
