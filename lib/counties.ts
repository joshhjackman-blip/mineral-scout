...
export const COUNTIES: Record<string, County> = {
  ...
  reeves: {
    ...
    geoJsonPath: '/reeves_parcels_enriched.geojson?v=2026roll-3',
    mapGeoJsonPath: '/reeves_parcels_map.geojson?v=2026roll-3',
    ownershipPctIsDecimal: true,
    abstractField: 'ABSTRACT_L',
    nriCode: '',
    operatorPatterns: [
  ...
  pecos: {
    ...
    geoJsonPath: '/pecos_parcels_enriched.geojson?v=2026roll-3',
    mapGeoJsonPath: '/pecos_parcels_map.geojson?v=2026roll-3',
    ownershipPctIsDecimal: true,
    abstractField: 'ABSTRACT_L',
    nriCode: '',
    operatorPatterns: [
